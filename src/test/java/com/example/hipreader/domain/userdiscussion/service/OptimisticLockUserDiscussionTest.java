...
public class OptimisticLockUserDiscussionTest {
	...
	@DisplayName("[Optimistic] 다양한 신청 인원에 대한 성능 테스트 (10회 반복)")
	void testOptimisticLock_MultiSize(int totalUsers) throws InterruptedException, IOException {
		// 평균 통계를 위한 변수 초기화
		...
		// 파일로 결과 저장
		try (BufferedWriter writer = new BufferedWriter(new FileWriter("optimistic_test_summary.txt", true))) {
